...
firepad.AlternateAdapter = (function (global) {
  ...
  AlternateAdapter.prototype.monitorHistoryStartingAt_ = function(revision) {
    ...
    var self = this;
    console.log('IN MONITOR HISTORY STARTING AT');
    ...
    setTimeout(function() {
      ...
      request.open('GET', 'http://127.0.0.1:3000/history/646465465', false);
      request.send(null);
      if(request.status === 200) {
        console.log(request.responseText);
        _.assign(
          self.pendingReceivedRevisions_, JSON.parse(request.responseText));
