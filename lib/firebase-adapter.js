...
firepad.FirebaseAdapter = (function (global) {
  ...
  FirebaseAdapter.prototype.getRevision = function() {
  ...
  FirebaseAdapter.prototype.sendOperation = function (operation, callback) {
    ...
    assert(this.document_.targetLength === operation.baseLength, "FIREBASE sendOperation() called with invalid operation.");
    ...
    function doTransaction(revisionId, revisionData) {
      console.log('REVISIONID', revisionId, revisionData);
  ...
  FirebaseAdapter.prototype.handlePendingReceivedRevisions_ = function() {
    console.log('FIREBASEHANDLEPENDINGREVISIONS');
  ...
  FirebaseAdapter.prototype.parseRevision_ = function(data) {
    console.log('PARSE REVISION', data);
