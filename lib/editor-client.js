...
firepad.EditorClient = (function () {
  ...
  EditorClient.prototype.setAlternateAdapter = function(adapter) {
    var self = this;
    self.alternateAdapter = adapter;
    self.alternateAdapter.registerCallbacks({
      ack: function() {
        self.serverAck();
      ...
      operation: function(operation) {
        console.log('OPERATIONCALLBACK', operation);
  ...
  EditorClient.prototype.sendCursor = function (cursor) {
    ...
    this.alternateAdapter.sendCursor(cursor);
  };
  ...
  EditorClient.prototype.sendOperation = function (operation) {
    ...
    this.alternateAdapter.sendOperation(operation);
    this.emitStatus();
  };
