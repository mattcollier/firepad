...
firepad.Firepad = (function(global) {
  ...
  var AlternateAdapter = firepad.AlternateAdapter;
  ...
  function Firepad(ref, place, options) {
    ...
    this.alternateAdapter_ = new AlternateAdapter(ref, userId, userColor);
    ...
    this.client_.setAlternateAdapter(this.alternateAdapter_);
    ...
    this.alternateAdapter_.on('ready', function() {
      self.ready_ = true;
    ...
    this.firebaseAdapter_.on('ready', function() {
      ...
      // FIXME: remove after firbase adapter is eliminated
      self.alternateAdapter_.setReady(true);
      self.alternateAdapter_.setRevision(self.firebaseAdapter_.getRevision());
